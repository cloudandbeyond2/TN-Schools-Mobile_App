...
function main() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        yield prisma.portfolio.deleteMany({
        ...
        console.log(`Successfully seeded portfolio for student ID: ${student.id} (${((_a = student.user) === null || _a === void 0 ? void 0 : _a.name) || 'Arjun Kumar'})`);
    });
}
main()
    .catch((e) => {
