...
function main() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        yield prisma.studentStoryProgress.deleteMany({});
        yield prisma.storyPage.deleteMany({});
        yield prisma.storyChapter.deleteMany({});
        yield prisma.storyBook.deleteMany({});
        for (const bookInfo of storiesData) {
            const book = yield prisma.storyBook.create({
                data: {
            ...
            for (const chapInfo of bookInfo.chapters) {
                const chapter = yield prisma.storyChapter.create({
                    data: {
                        storyBookId: book.id,
                ...
                yield prisma.storyPage.createMany({
