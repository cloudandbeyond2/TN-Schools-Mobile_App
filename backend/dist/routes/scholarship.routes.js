...
router.get('/', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const enriched = results.map(s => {
            ...
            return Object.assign(Object.assign({}, s), { daysLeft: isNaN(daysLeft) ? null : daysLeft, isExpired: isNaN(daysLeft) ? false : daysLeft < 0, isUrgent: !isNaN(daysLeft) && daysLeft >= 0 && daysLeft <= 30 });
        });
...
router.get('/:id', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        res.json({
            success: true,
            data: Object.assign(Object.assign({}, scholarship), { daysLeft: isNaN(daysLeft) ? null : daysLeft, isExpired: isNaN(daysLeft) ? false : daysLeft < 0, isUrgent: !isNaN(daysLeft) && daysLeft >= 0 && daysLeft <= 30 })
        });
    }
    catch (err) {
        res.status(500).json({ success: false, error: String(err) });
